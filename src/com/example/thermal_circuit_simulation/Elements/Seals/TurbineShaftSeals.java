...
public class TurbineShaftSeals extends Elements implements MatrixCompilation {
    ...
    public TurbineShaftSeals(String name, HashMap<Elements, Double> elementContributionToSteamConsumptionInSeals, TurbineCylinders turbineCylinder) {
        super(name);
